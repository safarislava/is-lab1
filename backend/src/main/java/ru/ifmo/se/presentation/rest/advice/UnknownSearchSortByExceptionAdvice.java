...
@Provider
public class UnknownSearchSortByExceptionAdvice implements ExceptionMapper<UnknownSearchSortByException> {

    @Override
    public Response toResponse(UnknownSearchSortByException exception) {
